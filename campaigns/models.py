...
class Campaign(models.Model):
    ...
    slug = models.SlugField(max_length=255, null=True, blank=True) #rearry??
    ...
    def save(self, *args, **kwargs):
        ...
        #if slug exists in the DB assign, generate the next slug 
        # appending the number of items in the DB 
